...
var Android = {
  ...
  start: function(avdName) {
    ...
    return spawnWaitFor(
      ANDROID_HOME + '/tools/emulator -verbose -avd "' + avdName + '"',
  ...
  createAVD: function(targetId, name, hardwareOptions) {
    ...
    var _this = this;
    return ezspawn(
      'avdmanager create avd -c 2000M -n ' + name + ' -k "system-images;android-26;google_apis_playstore;x86" -d "Nexus 6"'
    )
    .then(function() {
      if (!hardwareOptions) {
  ...
  listAVDs: function() {
    verbose('listAVDs()');
    return ezspawn('avdmanager list avd').then(function(output) {
  ...
  listTargets: function() {
    verbose('listTargets()');
    return ezspawn('avdmanager list target').then(function(output) {
